...
from utils.sampling import random_pick_user,mnist_noniid_given_dataset_ratio
...
fh = logging.FileHandler('./log/'+str(args.schedule_policy)+'_iid_'+str(args.iid)+args.differ_label +'.log')
...
if __name__ == '__main__':
    ...
    #generate wireless transmission argument
    ...
    expect_transmite_time = T_E #1.9706
    ...
    for iter in range(1, args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            if args.schedule_policy == 'based_on_optimize_global_convergence_time':
        ...
        user_index = random_pick_user(scheduling_probability_list)
        w_locals_choosen = w_locals[user_index:user_index+1]

        #aggregation
        w_glob = average_gradients_schedule(w_locals_choosen, dataset_size_ratio[user_index:user_index + 1],
                                            scheduling_probability_list[user_index:user_index + 1])
        total_communication_time += (calculate_transmite_time(transmite_power=[user_CSI.transmite_power[user_index]],
                                                              ...
                                                              S=net_total_params) + args.T_LC_T_BC)
    ...
    io.savemat('./log/' + args.schedule_policy + args.differ_label + '.mat',
